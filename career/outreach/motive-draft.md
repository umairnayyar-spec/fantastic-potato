...
## Research hooks (verified via web search)
...
I've applied for the [ROLE] opening ([req 8620742002]) and wanted to reach
out directly. Companies at your stage usually feel the strain in exactly the
places I've built before: hiring velocity, comp structures, and keeping
culture intact through hypergrowth.

Would you be open to a 15-minute chat? Happy to share specifics either way.

Umair Nayyar Khan
+92 300 5240000 · umair.nayyar@gmail.com · linkedin.com/in/umairkhan99
...
- [ ] Contact identified (name + channel)
- [ ] [ROLE] placeholder filled from the actual posting title
- [ ] Approved by Umair
- [ ] Sent (then update tracker → outreach-sent)
