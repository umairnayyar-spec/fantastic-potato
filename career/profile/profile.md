...
> Every skill and agent in this repo reads from this file. Keep it accurate and
> up to date — application forms are filled with EXACTLY what is written here.
> Replace every `TODO` before first use.
...
<!-- Only shared when a form explicitly requires them. Ask the person first. -->

1. TODO — name, title, relationship, email/phone
2. TODO

## Never do

- Never fabricate experience, dates, titles, degrees, or certifications.
- Never share salary history unless a form makes it mandatory.
- Never submit an application without showing me the filled form first.
